...
This brief follows `docs/features/initial/08-decision-process.md §2`. It is neutral; the options carry consequences traced to the rules, and the Contemplator's recommendation is recorded per option (clearly labelled as a recommendation, not a ruling).
